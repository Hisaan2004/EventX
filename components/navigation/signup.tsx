...
export default function SignUpScreen() {
  return (
    <ParallaxScrollView
      ...
      <TextInput keyboardType="email-address" style={styles.inputstyles}  placeholderTextColor={"white"} />
      <Text style={{color: "white", textAlign: "center", fontWeight: "bold",fontSize:20,alignItems:"center"}}>Password</Text>
      <TextInput keyboardType="visible-password" style={styles.inputstyles}  placeholderTextColor={"white"} />
      </ThemedView>

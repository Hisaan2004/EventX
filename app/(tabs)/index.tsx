...
export default function HomeScreen() {
  return (
    <ParallaxScrollView
      ...
      <TextInput keyboardType="email-address" style={styles.inputstyles} placeholder='hello@gmail.com'  placeholderTextColor={"grey"} />
      <Text style={{color: "white", textAlign: "center", fontWeight: "bold",fontSize:20,alignItems:"center"}}>Password</Text>
      <TextInput keyboardType="visible-password" style={styles.inputstyles} placeholder='Your Password' placeholderTextColor={"grey"} />
      </ThemedView>
      ...
      <Pressable style={styles.buttonStyle}>
        <Text style={{ color: "white", textAlign: "center", fontWeight: "normal",backgroundColor:'black',fontSize:20 }}>Login</Text>
      </Pressable>
      <Link href={"signup.tsx"}>
        <Text style={{ fontWeight: "500",color:"white",paddingLeft:10 }}>
          Go to 
        </Text>
        <Text style={{ fontWeight: "bold",color:"white",paddingBottom:10 }}> Sign Up</Text>
      </Link>
